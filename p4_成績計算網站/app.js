...
//要控制的對象, duration, 控制對象的原始狀態, 控制對象的結束狀態, 提早或延後動畫開始時間
time_line
...
addButton.addEventListener("click", () => {
  ...
  newInput3.classList.add("class-number");
...
//排序演算法
let btnD = document.querySelector(".sort-descending");
let btnA = document.querySelector(".sort-ascending");
